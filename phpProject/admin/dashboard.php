...
<body>
    ...
    ?>
                ...
                <div class="col s12 m12 l4">
                    <div class="card stats-card">
                        <div class="card-content">
                            <span class="card-title">Danh sách chờ</span>
                            <?php
                ...
                <div class="col s12 m12 l12">
                    <div class="card invoices-card">
                        <div class="card-content">
                            ...
                            <span class="card-title" style="font-size:30px;">ĐƠN NGHỈ PHÉP</span>
        ...
        {         
            ...
            if($stats==1){
                ?>
                                            ...
                                            <?php } if($stats==2)  { ?>
                                            <span style="color: red">Notauth</span>
                                            <?php } if($stats==0)  { ?>
                                        ...
                                        <td><a href="leave-details.php?leaveid=<?php echo htmlentities($result->lid);?>"
                                                class="waves-effect waves-light btn blue m-b-xs">chi tiết</a></td>
                                    </tr>
                                    <?php $cnt++;} }?>
                                </tbody>
                            </table>
